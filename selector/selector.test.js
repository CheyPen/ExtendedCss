(function () {
    ...
    QUnit.test('Test ExtendedSelector', function (assert) {
      var checkElements = function checkElements(elements, selector) {
    ...
    QUnit.test('Test -ext-matches-css', function (assert) {
      ...
      assert.equal(1, elements.length);
      assert.equal(elements[0], document.getElementById('test-div-background')); // Standard syntax
    ...
    QUnit.test('Test -ext-matches-css with opacity property', function (assert) {
      ...
      var elements = selector.querySelectorAll();
      assert.equal(1, elements.length);
      assert.equal(elements[0], document.getElementById('test-opacity-property')); // Standard syntax
    ...
    QUnit.test('Test -ext-matches-css-before', function (assert) {
      ...
      var elements = selector.querySelectorAll();
      assert.equal(1, elements.length);
      assert.equal(elements[0], document.getElementById('test-div-before')); // Standard syntax
    ...
    QUnit.test('Test -ext-matches-css-after', function (assert) {
      ...
      var elements = selector.querySelectorAll();
      assert.equal(1, elements.length);
      assert.equal(elements[0], document.getElementById('test-div-after')); // Standard syntax
    ...
    QUnit.test('Test regular expressions flags support in :contains', function (assert) {
      var elements;
      var selector;
      var selectorText;
    ...
    QUnit.test('Test xpath / nth-ancestor / upward', function (assert) {
      var selectorText;
      var selector;
      var elements;
    ...
    QUnit.test('Test xpath validation', function (assert) {
      var selectorText;
